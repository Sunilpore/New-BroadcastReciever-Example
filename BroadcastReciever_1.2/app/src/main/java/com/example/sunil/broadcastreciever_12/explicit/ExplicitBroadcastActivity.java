...
public class ExplicitBroadcastActivity extends AppCompatActivity {
    ...
    public void sendBroadcast(){
        ...
        /*Intent i = new Intent(this,ExampleBroadcastReciever.class);
        sendBroadcast(i);*/
        ...
        //Intent i = new Intent();
         ...
         //within same app
        //i.setClass(this,ExampleBroadcastReciever.class);
        //ComponentName cm = new ComponentName(this,ExampleBroadcastReciever.class);

         //for another app
        //ComponentName cm = new ComponentName("firebase.com.test","firebase.com.test.ExampleBroadcastReciever");
        //i.setComponent(cm);

        // i.setClassName("firebase.com.test","firebase.com.test.ExampleBroadcastReciever");
        //sendBroadcast(i);
        }
